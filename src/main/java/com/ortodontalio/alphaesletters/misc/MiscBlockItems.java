...
public class MiscBlockItems extends BlockItemRegistrator implements GroupRegistrable {
    ...
    public static final BlockItem LETTER_1 = new BlockItem(MiscBlocks.LETTER_1, new Item.Settings());
    public static final BlockItem LETTER_2 = new BlockItem(MiscBlocks.LETTER_2, new Item.Settings());
    public static final BlockItem LETTER_3 = new BlockItem(MiscBlocks.LETTER_3, new Item.Settings());
    public static final BlockItem LETTER_4 = new BlockItem(MiscBlocks.LETTER_4, new Item.Settings());
    public static final BlockItem LETTER_5 = new BlockItem(MiscBlocks.LETTER_5, new Item.Settings());
    public static final BlockItem LETTER_6 = new BlockItem(MiscBlocks.LETTER_6, new Item.Settings());
    public static final BlockItem LETTER_7 = new BlockItem(MiscBlocks.LETTER_7, new Item.Settings());
    public static final BlockItem LETTER_8 = new BlockItem(MiscBlocks.LETTER_8, new Item.Settings());
    public static final BlockItem LETTER_9 = new BlockItem(MiscBlocks.LETTER_9, new Item.Settings());
