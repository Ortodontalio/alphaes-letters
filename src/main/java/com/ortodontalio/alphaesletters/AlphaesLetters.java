...
public class AlphaesLetters implements ModInitializer {
    ...
    public static ItemGroup ALPHAES_LATIN;
    public static ItemGroup ALPHAES_CYRILLIC;
    public static ItemGroup ALPHAES_MISC;
    public static ItemGroup ALPHAES_TECH;
    ...
    public void onInitialize() {
        ...
        ALPHAES_CYRILLIC = cyrillicBlockItems.registerBlockItemsAndGroup("cyrillic");
        ALPHAES_LATIN = latinBlockItems.registerBlockItemsAndGroup("latin");
        ALPHAES_MISC = miscBlockItems.registerBlockItemsAndGroup("misc");
        ALPHAES_TECH = techBlockItems.registerBlockItemsAndGroup("tech");
