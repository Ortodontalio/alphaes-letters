...
import static com.ortodontalio.alphaesletters.AlphaesGameRules.EXFOLIATION_GR;

public class LetterFerroconcrete extends Block implements Exfoliatable {
    public static final MapCodec<LetterFerroconcrete> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                            Exfoliatable.ExfoliatedLevel.CODEC.fieldOf("exfoliation_state")
    ...
    protected void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        if (world.getGameRules().getBoolean(EXFOLIATION_GR)) {
